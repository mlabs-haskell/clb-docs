...
Please refer to [variants of use](/use) page
to figure out which better suits your needs.

# Using standlone CLB library

Use one of the following methods and refer to the library [API](/use/lib).

## Using CLB from GitHub

Use `source-repository-package` with the latest revision in `tag` field
to add CLB library to your project in
`cabal.project`:
